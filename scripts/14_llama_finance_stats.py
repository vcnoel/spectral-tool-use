#!/usr/bin/env python3
"""
Comprehensive statistics for Llama 3.1 8B Finance dataset.
"""
import pandas as pd
import numpy as np
...
# Load data
llama_df = pd.read_csv("data/llama_sweep_finance_1000_t03.csv")
llama_multi = pd.read_csv("data/llama_sweep_finance_1000_t03_multi_sweep.csv")
llama_multi['features_list'] = llama_multi['features'].apply(eval)
llama_multi['count'] = llama_multi['features_list'].apply(len)

print("="*80)
print("LLAMA 3.1 8B - FINANCE DATASET (N=1000)")
print("="*80)
...
results_df.to_csv("data/llama_finance_1000_comprehensive_stats.csv", index=False)

print(f"\n{'='*80}")
print("RESULTS SAVED")
print(f"{'='*80}")
print("  data/llama_finance_1000_comprehensive_stats.csv")
